...
public class Automobile {
    ...
    public String toString() {
        return "AUTOMOBILE:{" + targa +"|"+ modello +"|"+ colore +  "|" + km + "}";
    }

    public static boolean checkTarga(String t){
        return t.matches("[A-Z]{2}[0-9]{3}[A-Z]{2}");
    }

    public void aggiungiKm(float k){
        if(k<0 || k>10000000) throw new IllegalArgumentException("Chilometraggioinaccettabile");
        km += k;
    }
}
